...
const CalculationBasisPanel: React.FC<CalculationBasisPanelProps> = ({ inputs }) => {
    return (
        <div className="space-y-8">
             <h2 className="text-2xl font-bold text-gray-800 dark:text-slate-100 border-b border-gray-200 dark:border-slate-700 pb-4 print-block">
                Calculation Basis
            </h2>
            <div className="space-y-6">
                ...
                <Section title="User Inputs: Process Conditions">
                 ...
                 <Section title="User Inputs: N₂ Vaporizer & Ramps">
                    ...
                    <MetricItem label="N₂ Temp Step Size" value={formatNumber(inputs.n2TempStepSizeC)} unit="°C" />
                    <MetricItem label="N₂ Temp Hold Duration" value={formatNumber(inputs.n2TempHoldDurationHours)} unit="hours" />
                    ...
                    <MetricItem label="Intermediate Flow Ramp Time" value={formatNumber(inputs.flowRampIntermediateTimeHours)} unit="hours" />
                    <MetricItem label="End Flow Ramp Time" value={formatNumber(inputs.flowRampTotalTimeHours)} unit="hours" />
                </Section>
